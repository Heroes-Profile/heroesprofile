...
class CreateMasterMmrDataTlTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_mmr_data_tl', function (Blueprint $table) {
            $table->increments('master_mmr_data_tl_id');
    ...
    {
        Schema::dropIfExists('master_mmr_data_tl');
    }
}
