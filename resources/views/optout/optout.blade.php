...
<section>
  ...
  <label class="form-check-label" for="defaultCheck1">
    I understand that opting out also removes my data from any other sites or applications using Heroes Profile data, which may make me ineligeble for participation in some Amateur series league play. <p>
