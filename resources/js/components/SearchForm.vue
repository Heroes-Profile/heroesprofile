    ...
    <div class="filter-group">
      ...
      <b-form-group label="Role">
        <b-form-checkbox-group buttons v-model="form.role"  :name="rawfields.role.name"  >
          <b-form-checkbox v-for="option in rawfields.role" :value="option.key" :key="option.key"> <div class="checkbox-image" v-if="option.icon"><img :alt="option.name" :src="option.icon"/></div><span v-else>{{ option.text }}</span> </b-form-checkbox>
        </b-form-checkbox-group>
      </b-form-group>
    </div>
