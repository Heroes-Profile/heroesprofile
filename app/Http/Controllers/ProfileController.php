...
class ProfileController extends Controller
{
    ...
    public function __construct(GlobalDataService $globalDataService)
    {
        $this->globalDataService = $globalDataService;
            \Log::info('In constructor', ['service' => get_class($this->globalDataService)]);
    }
    ...
    public function showProfile(Request $request, $battletag, $blizz_id, $region)
    {
        ...
        return view('Profile.profile', compact('battletag', 'blizz_id', 'region'));
    }
