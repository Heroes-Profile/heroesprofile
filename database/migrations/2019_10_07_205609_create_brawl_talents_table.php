...
class CreateBrawlTalentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('heroesprofile_brawl.talents', function (Blueprint $table) {
          $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('heroesprofile_brawl.talents');
    }
}
