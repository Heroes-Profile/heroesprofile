<div>
    <nav class="bg-gray-dark text-white p-4 z-50 relative">
        ...
        <div class="flex space-x-4">
            <a href="#" class="bg-teal-500 px-4 py-2 rounded text-white hover:bg-teal-700">API</a>
            <a href="#" class="bg-blue-500 px-4 py-2 rounded text-white hover:bg-blue-700">Replay Uploader</a>
            <a href="#" class="bg-red-500 px-4 py-2 rounded text-white hover:bg-red-700">Patreon</a>
        </div>
        @if($isAuthenticated)
        <div class="relative group inline-block">
