...
class CreatePlayerTableMcl extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('heroesprofile_mcl.player', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('heroesprofile_mcl.player');
    }
}
