...
class GlobalTalentBuilderController extends GlobalsInputValidationController
{
    ...
    public function getData(Request $request){
        ...
        if(!$level_one && !$level_four && !$level_seven && !$level_ten && !$level_thirteen && !$level_sixteen && !$level_twenty){
            ...
            return $this->formatTalentData($talents, []);
        }
        ...
        $data = Cache::remember($cacheKey, $this->globalDataService->calculateCacheTimeInMinutes($gameVersion), function () use (
            ...
            foreach ($data as $key => $value) {
                // Check and initialize for level_one
                ...
                // Check and initialize for level_four
                ...
                // Check and initialize for level_seven
                ...
                // Check and initialize for level_ten
                ...
                // Check and initialize for level_thirteen
                ...
                // Check and initialize for level_sixteen
                ...
                // Check and initialize for level_twenty
                ...
                // Update wins and losses based on win_loss value
                if ($value["win_loss"] == 1) {
