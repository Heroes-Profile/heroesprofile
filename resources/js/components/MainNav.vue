    ...
    <nav class="bg-gray-dark text-white p-4 z-50 relative">
      <div class="flex justify-between items-center space-x-5 flex-wrap md:flex-nowrap">
        <a class="text-blue-600 hover:text-blue-800 flex items-center font-logo text-2xl" href="/">
          Heroes
          <img class="w-10 mx-2" src="/images/logo/heroesprofilelogo.png" />
          Profile
        </a>
        <div class="flex items-center space-x-4 flex-wrap md:flex-row">
          ...
          <div v-if="mainSearchAccount" class="relative group inline-block">
...
<script>
  export default {
    ...
    props: {
      ...
      mainSearchAccount: Object,
      altSearchAccount1: Object,
      altSearchAccount2: Object,
      altSearchAccount3: Object,
    },
    data(){
      return {
      }
    ...
    computed: {
      altSearchAccounts() {
        return [this.altSearchAccount1, this.altSearchAccount2, this.altSearchAccount3];
      }
    },
    watch: {
    },
