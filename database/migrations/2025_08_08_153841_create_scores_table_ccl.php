...
class CreateScoresTableCcl extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('heroesprofile_ccl.scores', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('heroesprofile_ccl.scores');
    }
}
