...
class CreateMasterMmrDataSlTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_mmr_data_sl', function (Blueprint $table) {
            $table->increments('master_mmr_data_sl_id');
    ...
    {
        Schema::dropIfExists('master_mmr_data_sl');
    }
}
