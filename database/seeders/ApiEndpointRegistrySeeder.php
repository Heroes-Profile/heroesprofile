...
class ApiEndpointRegistrySeeder extends Seeder
{
    ...
    private const ENDPOINTS = [
        ...
        ['ngs_division_match_history', 'NGS/Division/Matches', 'NGS Public Data', 7, 18, 100, 10000, 25000, 50000, 50000, 0],
        ['ngs_hero_stat', 'NGS/Hero/Stat', 'NGS Public Data', 7, 3, 50, 100, 1000, 10000, 1000000, 0],
        ['ngs_heroes_stats', 'NGS/Heroes/Stats', 'NGS Public Data', 7, 16, 50, 100, 1000, 10000, 1000000, 0],
        ['ngs_heroes_talents_stats', 'NGS/Heroes/Talents/Stats', 'NGS Public Data', 7, 17, 50, 100, 1000, 10000, 1000000, 0],
        ...
        ['ngs_player_match_history', 'NGS/Player/Matches', 'NGS Public Data', 7, 21, 100, 10000, 25000, 50000, 50000, 0],
        ['ngs_player_profile', 'NGS/Player/Profile', 'NGS Public Data', 7, 4, 50, 100, 1000, 10000, 1000000, 0],
        ['ngs_player_search', 'NGS/Players/Search', 'NGS Public Data', 7, 14, 50, 100, 1000, 10000, 1000000, 0],
        ['ngs_recent_matches', 'NGS/Matches', 'NGS Public Data', 7, 15, 100, 10000, 25000, 50000, 50000, 0],
        ['ngs_replay_data', 'NGS/Replay', 'NGS Public Data', 7, 22, 100, 10000, 25000, 50000, 50000, 0],
        ['ngs_single_player', 'NGS/Single/Player', 'NGS Public Data', 7, 12, 50, 100, 1000, 10000, 1000000, 0],
        ['ngs_single_player_hero', 'NGS/Player/Hero', 'NGS Public Data', 7, 19, 50, 100, 1000, 10000, 1000000, 0],
        ['ngs_single_player_map', 'NGS/Player/Map', 'NGS Public Data', 7, 20, 50, 100, 1000, 10000, 1000000, 0],
