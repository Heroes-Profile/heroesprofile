...
class MasterMmrDataQm extends Migration
{
  /**
  * The database schema.
  *
  ...
  */
  public function up()
  {
    $this->schema->create('master_mmr_data_qm', function (Blueprint $table) {
      $table->engine = 'InnoDB';
      $table->integer('master_mmr_data_qm_id')->autoIncrement();
  ...
  */
  ...
  {
    $this->schema->dropIfExists('master_mmr_data_qm');
  }
}
