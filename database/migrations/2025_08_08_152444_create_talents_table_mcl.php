...
class CreateTalentsTableMcl extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('heroesprofile_mcl.talents', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('heroesprofile_mcl.talents');
    }
}
