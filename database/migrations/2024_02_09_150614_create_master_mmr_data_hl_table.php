...
class CreateMasterMmrDataHlTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_mmr_data_hl', function (Blueprint $table) {
            $table->increments('master_mmr_data_hl_id');
    ...
    {
        Schema::dropIfExists('master_mmr_data_hl');
    }
}
