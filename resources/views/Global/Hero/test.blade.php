...
$return_data = Cache::remember($cache, \GlobalFunctions::instance()->calcluateCacheTime($timeframe, $game_versions), function () use ($game_versions_minor, $game_type, $region, $game_map,
