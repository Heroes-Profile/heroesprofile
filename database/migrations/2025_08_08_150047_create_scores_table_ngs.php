...
class CreateScoresTableNgs extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('heroesprofile_ngs.scores', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('heroesprofile_ngs.scores');
    }
}
