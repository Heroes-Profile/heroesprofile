...
class CreateGlobalHeroStatsTable extends Migration
{
    public function up()
    {
        Schema::connection('heroesprofile_globals')->create('global_hero_stats', function (Blueprint $table) {
            ...
            $table->unique(['game_version', 'game_type', 'league_tier', 'hero_league_tier', 'role_league_tier', 'game_map', 'hero_level', 'hero', 'mirror', 'region', 'win_loss'], 'unique');
            $table->index(['game_version', 'game_type', 'league_tier', 'hero_league_tier', 'role_league_tier', 'game_map', 'hero_level', 'hero', 'mirror', 'region', 'win_loss', 'games_played'], 'primary_gamesPlayed');
        });
    }
