<template>
  <div>
    <page-heading :infoText1="infoText1" :heading="'Heroes International'"></page-heading>
...
export default {
  ...
  data(){
    return {
      infoText1: "Click a League below to see Main Heroes International stats, or Nation Cup stats",
    }
  },
  created(){
  },
