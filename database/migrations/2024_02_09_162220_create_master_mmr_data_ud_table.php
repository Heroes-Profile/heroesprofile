...
class CreateMasterMmrDataUdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_mmr_data_ud', function (Blueprint $table) {
            $table->increments('master_mmr_data_ud_id');
    ...
    {
        Schema::dropIfExists('master_mmr_data_ud');
    }
}
