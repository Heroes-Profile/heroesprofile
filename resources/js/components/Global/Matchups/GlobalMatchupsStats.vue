  ...
  <div>
    ...
    <div v-else>
      ...
      <div v-if="allyenemydata" class="flex flex-wrap gap-4">
        <hero-group-box :text="'TOP 5 ALLIES ON HEROS TEAM'" :data="allyenemydata.ally"></hero-group-box>
        <hero-group-box :text="'TOP 5 THREATS ON ENEMIES TEAM'" :data="allyenemydata.enemy"></hero-group-box>
